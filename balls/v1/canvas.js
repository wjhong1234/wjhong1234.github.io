...
window.addEventListener('mouseup', function(e) {
	balls.push(new Ball(e.x, e.y, makeRadius, newColour));
	makeRadius = 20;
...
function mouseBall() {
	if (mousedownID != -1) {
		c.beginPath();
		c.arc(mouseX, mouseY, makeRadius, Math.PI *2, false);
...
function animate() {
	...
	c.fillStyle = '#3D5467';
	c.textAlign = 'center';
	c.fillText("CLICK TO MAKE BALLS", innerWidth / 2, innerHeight / 3);
